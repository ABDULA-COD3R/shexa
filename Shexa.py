...
def chk():
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/ABDULA-COD3R/samad/main/samad.id.txt").text
    if id in httpCaht:
      ...
      print("\x1b[91mBarezm Id kat active nya Tkaya bo Active krdn nama bnera bo telegram @SAMAD_SOFTWARE.......")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
